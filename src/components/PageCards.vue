  ...
  <Layout>
    <div class="mx-6 -mt-6 text-cWhite">
      ...
      <div class="flex justify-between text-cWhite">
        <div class="flex items-center">
          ...
          <div class="text-2xl font-extrabold ml-3">3,000</div>
        </div>
      ...
      <!-- Card info -->
      <div class="relative h-60 mt-8 z-0">
        <div
        ...
        >
          ...
          <div class="font-extrabold text-xl mt-6 leading-tight">Mark Henry</div>
          ...
          <div class="flex items-center font-extrabold text-xs">
            ...
            <div class="flex items-center ml-8">
              <span>CVV:</span><span class="text-xl pt-2 font-bold ml-2">***</span>
            </div>
          </div>
          <div class="flex justify-end">
    ...
    <div>
      ...
      <div class="flex justify-between bg-c4 rounded-t-3xl py-5 px-6 mt-8">
        <div class="flex flex-col items-center text-center cursor-pointer">
          ...
          <div class="mt-2 text-c3 text-sm font-thin">Freeze card</div>
        </div>
        <div class="flex flex-col items-center text-center cursor-pointer">
    ...
    <teleport to="#layer1">
      <Modal :isVisible="isAddingNewCard" @overlay-click="isAddingNewCard = false">
        ...
        <div class="flex justify-end">
          <button
            class="px-4 py-2 border border-c1 bg-c1 text-cWhite rounded-lg text-sm mt-2"
          >
            Add card
          </button>
        </div>
